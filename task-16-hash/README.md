...
The minimal feature requirements for your database system are one of:

- Your own implementation of a hashmap, with manual allocations / resizing
- A balanced 5th order b-tree

___Fun expansions (optional)___
