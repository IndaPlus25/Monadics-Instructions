...
If you're not familiar with the C language I recommend reading up on it online, for example [GeeksForGeeks](https://www.geeksforgeeks.org/c-programming-language/).
