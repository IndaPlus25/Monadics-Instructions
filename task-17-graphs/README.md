...
To make your Kattis-experience easier, see [the templates](./kattis_templates/). If you're mot all förmodan using Java, make use of [this utility class](https://open.kattis.com/download/Kattio.java?1a0093=) to simplify input-output fast enough to satisfy the judge.
