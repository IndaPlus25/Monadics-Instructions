...
Feel free to check out [Ripes](https://github.com/mortbopet/Ripes) as well. There are some differences (label names and amount of ecalls), but in general they are fairly similar.
...
[Projectf](https://projectf.io/posts/riscv-cheat-sheet/) has a really nice list of instructions, as well as guides (with examples!) on each kind.
