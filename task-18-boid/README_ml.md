...
1) Create a repository named `<KTH_ID>-boid`. (yes, same name as if you did the other task!)
2) Get started! (Probably with Python, but it can be done in any language. Matrix multiplications are the same anywhere anyway 🤷‍♂️)
